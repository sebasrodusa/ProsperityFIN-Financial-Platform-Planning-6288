  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Routes>
        ...
        <Route path="/crm" element={<ProtectedRoute allowedRoles={['admin','manager','financial_professional']}>
          <CRMDashboard />
        </ProtectedRoute>} />
        
        <Route path="/clients/:clientId/crm" element={<ProtectedRoute allowedRoles={['admin','manager','financial_professional']}>
          <ClientCRM />
        </ProtectedRoute>} />
        
        {/* Client Portal - Only accessible by clients */}
        <Route path="/client-portal" element={<ProtectedRoute allowedRoles={['client']}>
          <ClientPortal />
        </ProtectedRoute>} />
        
        {/* Client Financial Analysis - Only accessible by clients */}
        <Route path="/client-financial-analysis" element={<ProtectedRoute allowedRoles={['client']}>
          <ClientFinancialAnalysis />
        </ProtectedRoute>} />
        
        {/* Professional routes - Not accessible by clients */}
        <Route path="/clients" element={<ProtectedRoute allowedRoles={['admin','manager','financial_professional']}>
          <ClientManagement />
        </ProtectedRoute>} />
        
        <Route path="/clients/:clientId" element={<ProtectedRoute allowedRoles={['admin','manager','financial_professional']}>
          <ClientDetails />
        </ProtectedRoute>} />
        
        {/* Consolidated Financial Analysis - accessible from multiple places */}
        <Route path="/financial-analysis" element={<ProtectedRoute allowedRoles={['admin','manager','financial_professional']}>
          <FinancialAnalysis />
        </ProtectedRoute>} />
        
        <Route path="/financial-analysis/:clientId" element={<ProtectedRoute allowedRoles={['admin','manager','financial_professional']}>
          <FinancialAnalysis />
        </ProtectedRoute>} />
        
        {/* Financial Report - Accessible by both professionals and clients (for their own data) */}
        <Route path="/clients/:clientId/report" element={<ProtectedRoute>
          <ClientFinancialReport />
        </ProtectedRoute>} />
        
        <Route path="/proposals" element={<ProtectedRoute allowedRoles={['admin','manager','financial_professional']}>
          <ProposalManagement />
        </ProtectedRoute>} />
        
        <Route path="/users" element={<ProtectedRoute allowedRoles={['admin','manager']}>
          <UserManagement />
        </ProtectedRoute>} />
        
        {/* Admin-only routes */}
        <Route path="/projections-settings" element={<ProtectedRoute allowedRoles={['admin']}>
          <ProjectionsSettings />
        </ProtectedRoute>} />
